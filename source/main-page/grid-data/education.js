...
export const Education = {
  ...
  grids: [
    ...
    {
      idx: 2,
      //itemStyle: {background: '#4ebf14', color: 'black'},
    ...
    {
      idx: 3,
      //itemStyle: {background: '#ef7b00', color: 'black'},
      thumb: <img className='school-emblem' src='resources/icon-school/nus.jpg'></img>,
      content: <div>{'NUS'}</div>
    },
    {
      idx: 4,
      //itemStyle: {background: '#9c51ff', color: 'white'},
    ...
    {
      idx: 5,
      //itemStyle: {background: '#ffee9c', color: 'black'},
    ...
    {
      idx: 6,
      //itemStyle: {background: '#83ff83', color: 'black'},
